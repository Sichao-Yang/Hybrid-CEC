...
const std::string gate_type[6] = {"and", "xor", "majority",
                                  "HA",  "FA",  "UNUSE"};
class Bitset;
...
public:
  ...
  bool is_sat;
  int *input, *topo_index, *used, *model, *size, *q, *active, *is_input,
      *topo_counter, *table, *var_stamp, *fanout, *par, *xors_bot, *xors_id,
      *bucket, *task_sign;
  vec<type_gate> gate;
  type_cell *cell;
  vec<int> *inv_C, *inv_V;
  ...
  std::chrono::high_resolution_clock::time_point clk_st =
